...
import BookClasses.FrameSequencer;
...
public interface VideoCapturer
{
   ...
   *  @return BufferedImage of screen capture
   *  @throws Exception if unable to capture screen */
   ...
   * @param frameRate number of frames per second as int
   */
